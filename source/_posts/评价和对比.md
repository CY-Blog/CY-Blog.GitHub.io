...
| 算法  | UIQM   | UCIQE   |NIQE   |
|--------|--------|--------|--------|
| 原始图像 | 0.6713481831612926 | 0.37157640072660214 |第一行 |
| IBLA | 第二行 | 第二行 |第二行 |
| UDCP | 第三行 | 第三行 |第三行 |
| ULAP | 第一行 | 第一行 |第一行 |
| RGHS | 第二行 | 第二行 |第二行 |
| FunieGAN | 0.7381959285635713 | 0.4043115087836039 |第一行 |
| Shallow-UWnet-main | 1.7387123038742932315| 0.5174038742932315 |第二行 |
| 本研究算法 | 1.6274744899637812 | 0.510959335144234 |第三行 |
{% note info %}
9093
{% endnote %}
| 算法  | UIQM   | UCIQE   |NIQE   |
|--------|--------|--------|--------|
| 原始图像 | 0.6713481831612926 | 0.27611748881019615 |第一行 |
| IBLA | 第二行 | 第二行 |第二行 |
| UDCP | 第三行 | 第三行 |第三行 |
| ULAP | 第一行 | 第一行 |第一行 |
| RGHS | 第二行 | 第二行 |第二行 |
| FunieGAN | 0.7381959285635713 | 0.3405413878691030 |第一行 |
| Shallow-UWnet-main | 1.7387123038742932315| 0.50889738758890295 |第二行 |
| 本研究算法 | 1.6274744899637812 | 0.5147004607909507 |第三行 |
{% note info %}
9113
{% endnote %}
| 算法  | UIQM   | UCIQE   |NIQE   |
|--------|--------|--------|--------|
| 原始图像 | 0.6713481831612926 | 0.3345216064925566 |第一行 |
| IBLA | 第二行 | 第二行 |第二行|
| UDCP | 第三行 | 第三行 |第三行 |
| ULAP | 第一行 | 第一行 |第一行 |
| RGHS | 第二行 | 第二行 |第二行 |
| FunieGAN | 0.7381959285635713 | 0.36149838860870104 |第一行 |
| Shallow-UWnet-main | 1.7387123038742932315| 0.50985266601166835 |第二行 |
| 本研究算法 | 1.6274744899637812 | 0.5476123264821622 |第三行 |
##### 时间
| 算法    | 时间  |
|--------|--------|
| 原始图像 | 第一行 | 
